          ...
          <div class="col-md-12">
            <div class="card ">
              ...
              <table>
                  ...
                  <?php if (isset($cus) && is_array($cus) && !empty($cus)): ?>
                    <?php foreach ($cus as $customer): ?>
                      <tr>
                        <td><?= htmlspecialchars($customer['CODE_CUSTOMER']) ?></td>
                        <td><?= htmlspecialchars($customer['NAME_CUSTOMER']) ?></td>
                        <td><?= htmlspecialchars($customer['DATE_OF_BIRTH']) ?></td>
                        <td><?= htmlspecialchars($customer['ADDRESS_CUSTOMER']) ?></td>
                        ...
                        <td>
                          ...
                          <button class="btn edit" onclick="editCus(<?= htmlspecialchars($customer['CODE_CUSTOMER']) ?>)">Sửa</button>
                          <button class="btn del" onclick="deleteCus(<?= htmlspecialchars($customer['CODE_CUSTOMER']) ?>)">Xóa</button>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                    <button class="btn add" onclick="addCus(<?= htmlspecialchars($customer['CODE_CUSTOMER']) ?>)">Thêm</button>
                  <?php else: ?>
                    <tr>
...
<script>
  function deleteCus(CODE_CUSTOMER) {
    if (confirm("Bạn có chắc chắn muốn xóa khách hàng này không?")) {
      var xhr = new XMLHttpRequest();
      xhr.open("POST", "delCus.php", true);
      ...
      xhr.send("CODE_CUSTOMER=" + CODE_CUSTOMER);
